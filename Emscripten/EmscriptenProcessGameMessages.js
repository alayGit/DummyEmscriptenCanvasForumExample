...
var ScummWebModule = (() => {
  ...
  return (
function(ScummWebModule) {
  ScummWebModule = ScummWebModule || {};
...
var Module = typeof ScummWebModule != 'undefined' ? ScummWebModule : {};
...
["__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_StartWorkers","_EnqueueMessageOnWorker","___getTypeName","___embind_register_native_and_builtin_types","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'EmscriptenProcessGameMessages.wasm';
...
var ASM_CONSTS = {
  5232: () => { const canvas = findCanvasEventTarget("#canvas").offscreenCanvas; ScummWebModule['offScreenCanvas'] = canvas; ScummWebModule['imageData']= canvas.getContext('2d').createImageData(320, 200); },  
 5421: ($0, $1, $2) => { const data = $0; const size = $1; const value = $2; const imageData = ScummWebModule['imageData']; const ctx = ScummWebModule['offScreenCanvas'].getContext('2d'); for (let i = 0; i < size; i++) { if(value == 0) { imageData.data[i] = 0; } else { imageData.data[i] = 125; } } ctx.putImageData(imageData, 0, 0); }
};
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('EmscriptenProcessGameMessages.worker.js');
...
/** @type {function(...*):?} */
var _StartWorkers = Module["_StartWorkers"] = createExportWrapper("StartWorkers");

/** @type {function(...*):?} */
var _EnqueueMessageOnWorker = Module["_EnqueueMessageOnWorker"] = createExportWrapper("EnqueueMessageOnWorker");
...
run();
  ...
  return ScummWebModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = ScummWebModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return ScummWebModule; });
else if (typeof exports === 'object')
  exports["ScummWebModule"] = ScummWebModule;
